...
class CompletionParamsHandler:
    ...
    def __init__(self, **kwargs):
        ...
        self.response_format: Optional[Union[dict, Type[BaseModel]]] = kwargs.get("response_format")
        ...
        self.modalities: Optional[List[ChatCompletionModality]] = kwargs.get("modalities")
        self.prediction: Optional[ChatCompletionPredictionContentParam] = kwargs.get("prediction")
        ...
        self.logging_obj = kwargs.get("litellm_logging_obj", None)
        ...
        self.ensure_alternating_roles: Optional[bool] = kwargs.get("ensure_alternating_roles")
        self.user_continue_message: Optional[ChatCompletionUserMessage] = kwargs.get("user_continue_message")
        self.assistant_continue_message: Optional[ChatCompletionAssistantMessage] = kwargs.get("assistant_continue_message")
    ...
    def _process_optional_params(self):
        ...
        excluded_keys = set([
            "model", "messages", "timeout", "api_key", "api_base",
            "custom_llm_provider", "model_response", "logging_obj",
            "acompletion", "stream", "headers", "custom_prompt_dict",
            "logger_fn", "verbose", "input_cost_per_token", "output_cost_per_token",
    ...
    def _register_custom_pricing(self):
        ...
        if (self.kwargs.get("input_cost_per_token") is not None and 
            self.kwargs.get("output_cost_per_token") is not None):
            ...
            litellm.register_model({
                f"{self.custom_llm_provider}/{self.model}": {
                    ...
                    "output_cost_per_second": self.kwargs.get("output_cost_per_second"),
                    "litellm_provider": self.custom_llm_provider,
                }
            })
